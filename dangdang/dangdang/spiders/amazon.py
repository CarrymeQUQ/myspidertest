...
class AmazonSpider(RedisCrawlSpider):
    ...
    def parse_book_detail(self, response):
        ...
        item = {}
        item["book_title"] = response.xpath("//span[@id='ebooksProductTitle']/text()").extract_first().strip()
        ...
        item["book_price"] = response.xpath("//td[@class='a-color-price a-size-medium a-align-bottom']/span/text()").extract_first().strip()
